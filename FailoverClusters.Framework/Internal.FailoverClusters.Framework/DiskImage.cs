...
public class MSFT_DiskImage : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_DiskImage", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_DiskImage")
