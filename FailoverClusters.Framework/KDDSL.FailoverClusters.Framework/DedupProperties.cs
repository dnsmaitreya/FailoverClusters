...
public class MSFT_DedupProperties : MiInstanceBase
{
	...
	{
		CimInstance instanceId = new CimInstance("MSFT_DedupProperties", "root/windows/storage");
	...
	{
		CimInstance instance = new CimInstance("MSFT_DedupProperties", "root/windows/storage");
		return new MSFT_DedupProperties(session, instance);
	}

	public static IEnumerable<MSFT_DedupProperties> Enumerate(CimSession session)
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_DedupProperties")
