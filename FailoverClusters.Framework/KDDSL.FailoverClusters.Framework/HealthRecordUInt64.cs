...
public class MSFT_HealthRecordUInt64 : MSFT_HealthRecord
{
	...
	{
		CimInstance instanceId = new CimInstance("MSFT_HealthRecordUInt64", "root/windows/storage");
	...
	{
		CimInstance instance = new CimInstance("MSFT_HealthRecordUInt64", "root/windows/storage");
		return new MSFT_HealthRecordUInt64(session, instance);
	}

	public new static IEnumerable<MSFT_HealthRecordUInt64> Enumerate(CimSession session)
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_HealthRecordUInt64")
