...
public class MSFT_InitiatorId : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_InitiatorId", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_InitiatorId")
