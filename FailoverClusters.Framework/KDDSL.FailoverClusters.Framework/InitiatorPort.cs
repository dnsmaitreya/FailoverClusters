...
public class MSFT_InitiatorPort : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_InitiatorPort", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_InitiatorPort")
