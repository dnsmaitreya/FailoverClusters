...
public class MSFT_MaskingSet : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_MaskingSet", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_MaskingSet")
