...
public class MSFT_Partition : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_Partition", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_Partition")
