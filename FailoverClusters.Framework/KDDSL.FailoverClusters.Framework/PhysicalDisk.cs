...
public class MSFT_PhysicalDisk : MSFT_StorageFaultDomain
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_PhysicalDisk", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_PhysicalDisk")
