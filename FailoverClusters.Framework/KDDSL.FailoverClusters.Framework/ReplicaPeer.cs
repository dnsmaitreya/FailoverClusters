...
public class MSFT_ReplicaPeer : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_ReplicaPeer", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_ReplicaPeer")
