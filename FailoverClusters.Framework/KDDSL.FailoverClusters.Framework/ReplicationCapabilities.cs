...
public class MSFT_ReplicationCapabilities : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_ReplicationCapabilities", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_ReplicationCapabilities")
