...
public class MSFT_ReplicationGroup : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_ReplicationGroup", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_ReplicationGroup")
