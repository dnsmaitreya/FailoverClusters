...
public class MSFT_ResiliencySetting : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_ResiliencySetting", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_ResiliencySetting")
