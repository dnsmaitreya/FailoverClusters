...
public class MSFT_StorageDiagnoseResult : MiInstanceBase
{
	...
	{
		CimInstance instanceId = new CimInstance("MSFT_StorageDiagnoseResult", "root/windows/storage");
	...
	{
		CimInstance instance = new CimInstance("MSFT_StorageDiagnoseResult", "root/windows/storage");
		return new MSFT_StorageDiagnoseResult(session, instance);
	}

	public static IEnumerable<MSFT_StorageDiagnoseResult> Enumerate(CimSession session)
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageDiagnoseResult")
