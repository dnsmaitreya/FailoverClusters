...
public class MSFT_StorageHealth : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageHealth", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageHealth")
