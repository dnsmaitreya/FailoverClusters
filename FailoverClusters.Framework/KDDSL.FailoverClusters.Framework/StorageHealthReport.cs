...
public class MSFT_StorageHealthReport : MiInstanceBase
{
	...
	{
		CimInstance instanceId = new CimInstance("MSFT_StorageHealthReport", "root/windows/storage");
	...
	{
		CimInstance instance = new CimInstance("MSFT_StorageHealthReport", "root/windows/storage");
		return new MSFT_StorageHealthReport(session, instance);
	}

	public static IEnumerable<MSFT_StorageHealthReport> Enumerate(CimSession session)
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageHealthReport")
