...
public class MSFT_StorageQoSPolicy : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageQoSPolicy", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageQoSPolicy")
