...
public class MSFT_StorageQoSPolicyStore : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageQoSPolicyStore", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageQoSPolicyStore")
