...
public class MSFT_StorageQoSVolume : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageQoSVolume", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageQoSVolume")
