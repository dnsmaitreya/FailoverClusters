...
public class MSFT_StorageScaleUnit : MSFT_StorageFaultDomain
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageScaleUnit", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageScaleUnit")
