...
public class MSFT_StorageSetting : MiInstanceBase
{
	...
	{
		CimInstance instanceId = new CimInstance("MSFT_StorageSetting", "root/windows/storage");
	...
	{
		CimInstance instance = new CimInstance("MSFT_StorageSetting", "root/windows/storage");
		return new MSFT_StorageSetting(session, instance);
	}

	public static IEnumerable<MSFT_StorageSetting> Enumerate(CimSession session)
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageSetting")
	...
	public static GetOutParameters Get(CimSession Session)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/windows/storage", "MSFT_StorageSetting", "Get", methodParameters);
	...
	public static SetOutParameters Set(CimSession Session, ushort? NewDiskPolicy = null, uint? ScrubPolicy = null)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/windows/storage", "MSFT_StorageSetting", "Set", cimMethodParametersCollection);
	...
	{
		CimMethodParametersCollection methodParameters = new CimMethodParametersCollection();
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/windows/storage", "MSFT_StorageSetting", "UpdateHostStorageCache", methodParameters);
