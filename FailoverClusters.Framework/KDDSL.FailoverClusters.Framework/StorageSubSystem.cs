...
public class MSFT_StorageSubSystem : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageSubSystem", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageSubSystem")
