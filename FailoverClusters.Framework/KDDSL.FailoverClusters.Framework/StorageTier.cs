...
public class MSFT_StorageTier : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageTier", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_StorageTier")
