...
public class MSFT_TargetPort : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_TargetPort", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_TargetPort")
