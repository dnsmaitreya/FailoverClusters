...
public class MSFT_TargetPortal : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_TargetPortal", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_TargetPortal")
