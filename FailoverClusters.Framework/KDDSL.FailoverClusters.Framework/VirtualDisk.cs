...
public class MSFT_VirtualDisk : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_VirtualDisk", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_VirtualDisk")
