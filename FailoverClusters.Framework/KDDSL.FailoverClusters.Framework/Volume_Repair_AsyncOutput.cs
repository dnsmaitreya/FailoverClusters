...
public class MSFT_Volume_Repair_AsyncOutput : MSFT_StorageJobOutParams
{
	...
	{
		CimInstance instanceId = new CimInstance("MSFT_Volume_Repair_AsyncOutput", "root/windows/storage");
	...
	{
		CimInstance instance = new CimInstance("MSFT_Volume_Repair_AsyncOutput", "root/windows/storage");
		return new MSFT_Volume_Repair_AsyncOutput(session, instance);
	}

	public new static IEnumerable<MSFT_Volume_Repair_AsyncOutput> Enumerate(CimSession session)
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_Volume_Repair_AsyncOutput")
