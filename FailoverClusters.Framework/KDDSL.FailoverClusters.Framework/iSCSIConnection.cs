...
public class MSFT_iSCSIConnection : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_iSCSIConnection", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_iSCSIConnection")
