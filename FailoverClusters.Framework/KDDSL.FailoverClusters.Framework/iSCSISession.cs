...
public class MSFT_iSCSISession : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_iSCSISession", "root/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/windows/storage", "MSFT_iSCSISession")
	...
	public static SetCHAPSecretOutParameters SetCHAPSecret(CimSession Session, string ChapSecret = null)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/windows/storage", "MSFT_iSCSISession", "SetCHAPSecret", cimMethodParametersCollection);
