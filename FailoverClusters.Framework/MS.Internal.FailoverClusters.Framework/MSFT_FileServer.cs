...
public class MSFT_FileServer : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_FileServer", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_FileServer")
