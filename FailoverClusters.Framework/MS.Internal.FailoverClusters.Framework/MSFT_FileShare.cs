...
public class MSFT_FileShare : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_FileShare", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_FileShare")
