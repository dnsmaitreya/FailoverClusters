...
public class MSFT_FileStorageTier : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_FileStorageTier", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_FileStorageTier")
	...
	public static GetOutParameters Get(CimSession Session, string FilePath = null, char? VolumeDriveLetter = null, string VolumePath = null, MSFT_Volume Volume = null)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/microsoft/windows/storage", "MSFT_FileStorageTier", "Get", cimMethodParametersCollection);
	...
	public static SetOutParameters Set(CimSession Session, string FilePath = null, string DesiredStorageTierFriendlyName = null, string DesiredStorageTierUniqueId = null, MSFT_StorageTier DesiredStorageTier = null)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/microsoft/windows/storage", "MSFT_FileStorageTier", "Set", cimMethodParametersCollection);
	...
	public static ClearOutParameters Clear(CimSession Session, string FilePath = null)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/microsoft/windows/storage", "MSFT_FileStorageTier", "Clear", cimMethodParametersCollection);
