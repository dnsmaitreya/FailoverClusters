...
public class MSFT_HealthAction : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_HealthAction", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_HealthAction")
