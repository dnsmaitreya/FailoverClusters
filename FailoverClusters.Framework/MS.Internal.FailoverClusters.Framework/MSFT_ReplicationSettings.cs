...
public class MSFT_ReplicationSettings : MiInstanceBase
{
	...
	{
		CimInstance instanceId = new CimInstance("MSFT_ReplicationSettings", "root/microsoft/windows/storage");
	...
	{
		CimInstance instance = new CimInstance("MSFT_ReplicationSettings", "root/microsoft/windows/storage");
		return new MSFT_ReplicationSettings(session, instance);
	}

	public static IEnumerable<MSFT_ReplicationSettings> Enumerate(CimSession session)
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_ReplicationSettings")
