...
internal class RootContext : ScopeNodeContextBase, IHasPropertyPages
{
	...
	private void AddNewCluster(Cluster cluster, INotifyUser notifyUser, SnapinActionEventArgs e)
	{
		...
		finally
		{
			if (context == null)
			{
				KDDSL.ServerClusters.Utilities.BackgroundDisposeObject(cluster);
			}
		}
	}
	...
	private void RemoveChild(IContext context)
	{
		...
		KDDSL.ServerClusters.Utilities.BackgroundDisposeObject(context);
	...
	public override void Dispose()
	{
		...
		{
			KDDSL.ServerClusters.Utilities.BackgroundDisposeObject(childContext);
		}
