...
public class MSFT_Disk : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_Disk", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_Disk")
