...
public class MSFT_FileIntegrity : MiInstanceBase
{
	...
	{
		CimInstance instanceId = new CimInstance("MSFT_FileIntegrity", "root/microsoft/windows/storage");
	...
	{
		CimInstance instance = new CimInstance("MSFT_FileIntegrity", "root/microsoft/windows/storage");
		return new MSFT_FileIntegrity(session, instance);
	}

	public static IEnumerable<MSFT_FileIntegrity> Enumerate(CimSession session)
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_FileIntegrity")
	...
	public static GetOutParameters Get(CimSession Session, string FileName = null)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/microsoft/windows/storage", "MSFT_FileIntegrity", "Get", cimMethodParametersCollection);
	...
	public static RepairOutParameters Repair(CimSession Session, string FileName = null)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/microsoft/windows/storage", "MSFT_FileIntegrity", "Repair", cimMethodParametersCollection);
	...
	public static SetOutParameters Set(CimSession Session, string FileName = null, bool? Enable = null, bool? Enforce = null)
	{
		...
		CimMethodResult cimMethodResult = Session.InvokeMethod("root/microsoft/windows/storage", "MSFT_FileIntegrity", "Set", cimMethodParametersCollection);
