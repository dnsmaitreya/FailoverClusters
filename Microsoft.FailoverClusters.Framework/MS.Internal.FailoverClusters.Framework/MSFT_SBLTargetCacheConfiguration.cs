...
public class MSFT_SBLTargetCacheConfiguration : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_SBLTargetCacheConfiguration", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_SBLTargetCacheConfiguration")
