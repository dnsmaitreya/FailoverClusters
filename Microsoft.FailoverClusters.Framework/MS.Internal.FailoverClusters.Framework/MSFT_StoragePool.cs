...
public class MSFT_StoragePool : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StoragePool", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_StoragePool")
