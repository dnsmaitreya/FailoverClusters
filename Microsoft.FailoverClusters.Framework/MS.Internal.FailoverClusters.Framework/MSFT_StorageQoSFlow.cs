...
public class MSFT_StorageQoSFlow : MiInstanceBase
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageQoSFlow", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_StorageQoSFlow")
