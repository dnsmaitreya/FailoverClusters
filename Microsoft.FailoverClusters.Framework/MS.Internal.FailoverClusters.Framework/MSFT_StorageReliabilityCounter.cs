...
public class MSFT_StorageReliabilityCounter : MSFT_StorageObject
{
	...
	{
		CimInstance cimInstance = new CimInstance("MSFT_StorageReliabilityCounter", "root/microsoft/windows/storage");
	...
	{
		return from i in session.EnumerateInstances("root/microsoft/windows/storage", "MSFT_StorageReliabilityCounter")
